...
export class RemoveLeaveBalanceCheck1765900000000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Cập nhật function bỏ qua logic kiểm tra số ngày phép
    await queryRunner.query(`
      ...
      BEGIN
        ...
        IF OLD.status = 'pending'
          ...
          -- Không kiểm tra số ngày phép còn lại nữa
          UPDATE employee SET
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Khôi phục function với logic kiểm tra số ngày phép
    await queryRunner.query(`
      CREATE OR REPLACE FUNCTION update_employee_leave_days()
      RETURNS TRIGGER AS $$
      DECLARE
